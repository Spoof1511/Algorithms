...
int main(void) 
{
	...
	loadDefinitions("C:\\Users\\Alan\\Desktop\\sumofitspartsDZ\\definitions.txt", partContainer);
	processQueries("C:\\Users\\Alan\\Desktop\\sumofitspartsDZ\\queries.txt", partContainer);
